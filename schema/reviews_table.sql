...
-- Source: 10 Parquet files (37,510,000 reviews)
-- Created: 2025-10-28 (Updated with images column)
-- ===========================================
...
'Amazon Electronics reviews filtered by electronics-only whitelist. Contains 37.5M reviews for 348K products with complete metadata including images.';
...
'JSONB array of image objects with URLs (small/medium/large) - ~4.4% of reviews have images';
...
-- - Average review length: ~300 characters
-- - Reviews with images: 1,649,929 (4.4%)
-- - Verified purchases: 92.5%
-- - Storage estimate: ~30-35 GB (with indexes and images)
-- - Vector storage (when populated): ~110 GB additional
