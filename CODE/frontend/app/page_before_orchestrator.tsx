                            ...
                            <div className="mt-2">
                              ...
                              {product.hybrid_score && (
                                <span className="text-xs text-gray-500 ml-2">
                                  Score: {product.hybrid_score.toFixed(2)}
                                  {product.product_similarity > 0 && ` (P:${product.product_similarity.toFixed(2)}`}
                                  {product.review_similarity > 0 && ` R:${product.review_similarity.toFixed(2)})`}
                                </span>
                              )}
                            </div>
                          )}
